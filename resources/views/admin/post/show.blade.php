        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            ...
                            <a href="{{ route('posts.edit',['post'=>$post->id]) }}" class="btn btn-outline-secondary m-1">O'zgaryirish</a>
                            <form action="{{ route('posts.destroy',['post'=>$post->id]) }}" method="post">
                                @csrf 
                                @method('DELETE')
                                <button type="submit" class="btn btn-outline-dark m-1">O'chirish</button>
                            </form>
                            @endcanany
                        </div>
                    ...
                    <div class="mb-5">
                        <img class="img-fluid rounded w-100 mb-4" src="{{$post->photo ?(asset('storage/'.$post->photo)):('/img/carousel-1.jpg')}}" alt="Image">
                        <p>{{ $post->content }}</p>
                    </div>

                    <div class="mb-5">
                        <h3 class="mb-4 section-title">{{ $post->comments()->count() }} Qoldirilga Izohlar</h3>
                    ...
                    <div class="bg-light rounded p-5">
                        ...
                        <div class="form-group mb-0">
                            <input type="submit" value="Junatish" class="btn btn-primary">
                        </div>
                    </form>
                    @else
                    <p>izoh qoldirish uchun tizmiga kirishingiz kerak</p>
                    @endauth
                    </div>
                </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="mb-5">
                        <h3 class="mb-4 section-title">Yangi Postlar</h3>
