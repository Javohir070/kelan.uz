    ...
    <div class="row">
            <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3">
                ...
                <div class="panel-heading">
                    <h3 class="pt-3 font-weight-bold">Ro'yxatan O'tish</h3>
                </div>
                    ...
                    @csrf
                        <div class="form-group py-2">
                            <div class="input-field"> 
                                ...
                                <input name="name" type="text" placeholder="Ismingizni" required>
                            </div>
                        </div>
                        <div class="form-group py-2">
                            <div class="input-field"> 
                        ...
                        <div class="form-group py-1 pb-2">
                            <div class="input-field">
                                ...
                                <input name="password" type="password" placeholder="porol" required> 
                        ...
                        <div class="form-group py-1 pb-2">
                            <div class="input-field">
                                <span class="fas fa-lock px-2"></span> 
                                <input name="password_confirmation" type="password" placeholder="porolni tastiqlash" required> 
                                <button class="btn bg-white text-muted"> 
                                    <span class="far fa-eye-slash"></span>
                                </button> 
                            </div>
                        ...
                        <div class="text-center pt-4 text-muted">Siz Ro'yaxatn bormi? <a href="{{ route('login') }}">Kirish</a> </div>
                    </form>
                </div>
